  ...
  return (
    <div className="flex-1 bg-theme-color-tertiary text-text-normal flex flex-col justify-center items-center p-8">
      <div className="absolute top-4 left-4">
        <button
          onClick={() => router("/")}
          className="bg-theme-color-secondary hover:bg-theme-color-primary transition-all duration-300 ease-in-out text-text-normal py-1 px-4 w-max rounded-md"
        >
          Go Back to Home
        </button>
      </div>
      ...
      <p className="mb-8 text-lg text-center">
        Please signup to make backend development easier
      </p>
      <div className="bg-theme-color-primary p-4 rounded-lg shadow-lg w-full max-w-md h-44 overflow-hidden">
