...
export default function Hero() {
  ...
  useEffect(() => {
    const typed = new Typed(ref.current, {
      strings: ['Welcome to Devicode', 'Empowering Developers Everywhere', 'Simplify Backend Development','Accelerate Your Projects'],
      typeSpeed: 50,
      backDelay:20,
      backSpeed: 50,
      loop: true
    ...
    <div id="home">
      ...
      className="xl:w-[70%]">
        <div className="flex flex-col sm:px-16 px-8 gap-6 lg:gap-8 justify-center min-h-[100vh] z-10 relative">
          ...
          <h1 
          className="lg:text-5xl text-2xl font-bold text-text-normal leading-[2.3rem] lg:leading-[4rem]">
          ...
          className="lg:text-2xl text-base font-semibold text-text-light">
